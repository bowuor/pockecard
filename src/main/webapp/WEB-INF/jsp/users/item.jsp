            ...
            <div class="box-body">
                <div class="col-sm-8">
                    ...
                    <div class="box">
                        <div class="col-sm-9 col-sm-offset-1 col-md-10 col-md-offset-1 main">
                            <form:form acceptCharset="UTF-8" action="/users/item/updateItem" method="post" modelAttribute="item" cssClass="form-horizontal" role="form">
                                <div class="form-group">
                                    <label for="name" class="col-sm-3 control-label">Name</label>
                                    <div class="col-sm-9">
                                        <form:input path="name" id="name" type="text" cssClass="form-control" placeholder="Name of item" />
                                        <form:input path="id" id="id" value="${item.id}" type="hidden"/>
                ...
                <div class="col-sm-3">
                    <div style="margin-top: 50px">
                        <div class="box-body">
                                    <a href="/users/items" class="btn btn-default btn-sm">
                                        Back
                                    </a>
                        </div>
                    </div>
