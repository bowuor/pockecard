                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tr>
                                        <jsp:include page="/WEB-INF/jsp/common/pagination.jsp">
                                            <jsp:param name="paginatedRecord" value="itemPage"/>
            ...
            <div class="modal-body">
                <div class="box">
                    <div class="col-sm-9 col-sm-offset-1 col-md-10 col-md-offset-1 main">
                        <form:form acceptCharset="UTF-8" action="/users/item/createItem" method="post"
                                   modelAttribute="item" cssClass="form-horizontal" role="form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <form:input path="unitPrice" id="unitPrice" type="text" cssClass="form-control"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <form:textarea path="description" id="description" cssClass="form-control"
                                                   placeholder="Description of item"></form:textarea>
