...
<div class="box">
  ...
  <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
   ...
   <form:form acceptCharset="UTF-8" action="/admin/roles/form/${action}" method="post" modelAttribute="role" cssClass="form-horizontal" role="form">
     ...
     <div class="form-group">
       ...
       <div class="col-sm-4">
         <form:input path="description" id="description" type="text" cssClass="form-control" placeholder="Role description" />
